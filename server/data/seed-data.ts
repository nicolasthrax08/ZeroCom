...
// Seed data uses a dev-only deterministic encryption key.
// In production, ENCRYPTION_KEY must be a real random 32-byte key.
// These encrypted values are placeholders — re-run seed with real key.
function enc(phone: string): string {
  // Placeholder: in dev mode, the crypto module uses a dev key.
  // We store a marker so seed data is clearly identifiable.
  return `enc-dev-${phone}`;
}
...
export const SEED_USERS: User[] = [
  {
    id: 'user-free-buyer',
    phoneEncrypted: enc('13800000001'),
  ...
  },
  {
    ...
    phoneEncrypted: enc('13800000002'),
  ...
  },
  {
    ...
    phoneEncrypted: enc('13800000003'),
  ...
  },
  {
    ...
    phoneEncrypted: enc('13800000004'),
  ...
  },
  {
    ...
    phoneEncrypted: enc('13800000005'),
    phoneHash: 'hash-13800000005',
    displayName: '刘某 (被shadow-ban卖家)',
    role: 'USER',
    isShadowBanned: true,
    isHardBanned: false,
    termsAcceptedAt: '2026-06-01T00:00:00Z',
  ...
  {
    id: 'user-admin',
    phoneEncrypted: enc('13800000006'),
  ...
  {
    id: 'user-moderator',
    phoneEncrypted: enc('13800000007'),
